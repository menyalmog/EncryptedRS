...
RemoteStorage.Assets = {
  ...
  remoteStorageIconEncrypted: 'data:image/svg+xml;base64,',
...
(function(window) {
  ...
  RemoteStorage.Widget.prototype = {
	...
	*   encryption
    **/
    display: function(domID, encryption) {
      if (! this.view) {
    ...
    **/
    setView: function(view) {
      ...
      this.view.on('encrypt', function(secretKey) {
   ...
   * Same as <display>
   **/
  RemoteStorage.prototype.displayWidget = function(domID, encryption) {
    return this.widget.display(domID, encryption);
  };
  ...
  RemoteStorage.Widget.View.prototype = {
    ...
    **/
    ...
    showBubble: function(event){
      ...
      if (this.encryption && !this.userSecretKey) {
        this.bubble.querySelector('form.remotestorage-encrypt').userSecretKey.focus();
	  } else {
    ...
    display: function(domID, encryption) {
	  ...
	  if (encryption) {
		...
		// Encrypt button
		var encryptButton = setupButton(element, 'rs-encrypt', 'encryptIcon', this.events.encrypt);

		// Handle encryptButton state
		element.querySelector('form.remotestorage-encrypt').userSecretKey.addEventListener('keyup', function(event) {
		  if (event.target.value) {
    ...
    states:  {
		...
		if (this.encryption) {
		  if (this.userSecretKey) {
		    if (this.userSecretKeyError) {
              cube.src = RemoteStorage.Assets.remoteStorageIconError;
		      addClass(this.div.querySelector('.remotestorage-connected'), 'remotestorage-encryption');
		      addClass(this.div.querySelector('.remotestorage-invalid-key'), 'remotestorage-decryption-error');
			  this.showBubble();
		      ...
		      removeClass(this.div.querySelector('.remotestorage-invalid-key'), 'remotestorage-decryption-error');
              cube.src = RemoteStorage.Assets.remoteStorageIconEncrypted;
			}
		  } else {
		    addClass(this.div.querySelector('.remotestorage-connected'), 'remotestorage-encryption');
			this.showBubble();
      ...
      encrypted: function() {
	    this.div.querySelector('form.remotestorage-encrypt').userSecretKey.value = '';
		removeClass(this.div.querySelector('.remotestorage-connected'), 'remotestorage-encryption');
        this.cube.src = RemoteStorage.Assets.remoteStorageIconEncrypted;
        this.hideBubble();
      },
     ...
     * Event: encrypt
     *
     * Emitted when the encrypt button is clicked
     **/
