  ...
  RemoteStorage.Widget.View.prototype = {
    ...
    **/
    ...
    showBubble: function(event){
      ...
      if (this.div.querySelector('.remotestorage-connected').classList.contains('remotestorage-encryption') && !this.userSecretKey) {
