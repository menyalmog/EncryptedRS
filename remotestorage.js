    ...
    **/
    ...
    states:  {
      ...
      connected: function() {
		...
		if (this.encryption) {
		  if (this.userSecretKey) {
		    ...
		    addClass(this.div, 'remotestorage-encryption');
			this.showBubble();
		  }
		}
      ...
      encrypted: function() {
		...
		removeClass(this.div, 'remotestorage-encryption');
        this.cube.src = RemoteStorage.Assets.remoteStorageIconEncrypted;
        this.hideBubble();
      },
